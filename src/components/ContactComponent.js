...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.firstname && firstname.length < 3)
            errors.firstname = 'First name should be >= 3 char';
        else if(this.state.touched.firstname && firstname.length > 15)
            errors.firstname = 'First name should be <= 15 char';
        if(this.state.touched.lastname && lastname.length < 3)
            errors.lastname = 'Last name should be >= 3 char';
        else if(this.state.touched.lastname && lastname.length > 15)
            errors.lastname = 'Last name should be <= 15 char';
        
        const reg = /^\d+$/;
        if (this.state.touched.telnum && !reg.test(telnum))
            errors.telnum = 'Tel Num must be combination numbers'
